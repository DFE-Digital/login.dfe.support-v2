...
const getPageOfData = (source, pageNumber) => {
...
describe('When syncing diff users materialised view', () => {
  beforeEach(() => {
    ...
    directories.getPageOfUsers.mockReset().mockImplementation((pageNumber) => getPageOfData(testData.users, pageNumber));
    directories.getPageOfInvitations.mockReset().mockImplementation((pageNumber) => getPageOfData(testData.invitations, pageNumber));
