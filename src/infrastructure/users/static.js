...
const getById = async (userId) => users.find((x) => x.id === userId);

const getExistingIndex = async () => Promise.resolve('existing');

const createIndex = async () => Promise.resolve('new');

const updateIndex = async (users, index) => Promise.resolve(null);

const updateActiveIndex = async (index) => Promise.resolve(null);

const deleteUnusedIndexes = async () => Promise.resolve(null);

const getDateOfLastIndexUpdate = async () => Promise.resolve(undefined);

const setDateOfLastIndexUpdate = async (date) => Promise.resolve();
