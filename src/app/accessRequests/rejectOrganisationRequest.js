...
const get = async (req, res) => res.render('accessRequests/views/rejectOrganisationRequest', {
...
const post = async (req, res) => {
  ...
  if (model.requestFrom && model.requestFrom === 'organisation') return res.redirect(`/users/${model.request.user_id}/organisations`);
